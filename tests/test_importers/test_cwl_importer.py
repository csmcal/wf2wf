...
class TestCWLImporter:
    ...
    def test_import_demo_workflow(self, examples_dir, persistent_test_output):
        ...
        assert len(workflow.edges) == 3  # Diamond dependency: prepare_data feeds both analyze_data and generate_report
        ...
        expected_edges = {
            ...
            ("prepare_data", "generate_report"),  # generate_report needs data_file from prepare_data
            ("analyze_data", "generate_report")   # generate_report needs results_file from analyze_data
        }
    ...
    def test_parse_commandlinetool(self, persistent_test_output):
        ...
        # Check metadata
        assert workflow.meta['single_tool_conversion'] == True
    ...
    def test_resource_parsing(self, persistent_test_output):
        ...
        tool_content = {
            ...
            'inputs': {},
            'outputs': {
                'out': {'type': 'File', 'outputBinding': {'glob': '*'}}
            }
        }
