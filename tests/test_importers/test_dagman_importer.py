...
class TestDAGManImporter:
    ...
    def test_import_demo_workflow(self, dagman_examples, persistent_test_output):
        ...
        expected_deps = [("prepare_data", "analyze_data"), ("analyze_data", "generate_report")]
...
class TestDAGManImporterInlineSubmit:
    ...
    def test_import_inline_submit_workflow_metadata_preservation(self, persistent_test_output):
...
class TestDAGManImporterCompatibility:
    ...
    def test_equivalent_import_results(self, persistent_test_output):
        ...
        assert task_external.environment.container == task_inline.environment.container == "docker://tensorflow/tensorflow:latest" 